...
const podcasts = [
  {
    ...
    author: '出演者：やまと',
    title: 'ゆるっと人間探求',
    desc: '「人の物語から紐解く、人生においてコト」をサブタイトルに、ゲストのそれまでの人生をゆるっと振り返りながら、さまざまな価値観や考えに触れ、自分自身を振り返るきっかけにもなる番組です。',
  ...
  },
  {
    ...
    author: '出演者：やまと',
    title: '起業の失敗学',
    desc: '成功の仕方は千差万別だが、失敗というのは何か共通点があるのでは...!?先輩起業家から失敗エピソードを集めながら、「なるべく失敗を避けつつ、それでもチャレンジする素晴らしさ」を伝えていく番組です。',
    platforms: ['spotify'],
    link: '#',
  },
  {
    ...
    author: '出演者：やまと',
    title: 'クラシックる？',
    desc: '「クラシックってなんか難しそう！」そんなイメージを打破するように、クラシック愛好家の2人がわかりやすくクラシックの魅力や楽しみ方を語る番組です。',
    platforms: ['spotify', 'apple'],
    link: '#',
  },
  {
